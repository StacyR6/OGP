...
import PagesAjout from "../pages/ui-elements/Pages-Ajout";
...
const AjoutV = async(() => import("../pages/forms/ajout-veentes"));
const ModifV = async(() => import("../pages/forms/modifier-ventes"));
const AjoutD = async(() => import("../pages/forms/Ajout-depenses"));
const AjoutC = async(() => import("../pages/forms/Ajout-clients"));
const AjoutF = async(() => import("../pages/forms/Ajout-frs"));
...
const RowSelectionTablesV = async(() => import("../pages/tables/RowSelectionV"));
const RowSelectionTablesD = async(() => import("../pages/tables/RowSelectionD"));
const RowSelectionTablesC = async(() => import("../pages/tables/RowSelectionC"));
const RowSelectionTablesF = async(() => import("../pages/tables/RowSelectionF"));
...
const Ventes = {
  ...
  name: "Ventes",
  icon: DollarSignIcon,
  component: RowSelectionTablesV,
  children: null
};

const AjoutVentes = {
  path: "/ventes/ajout-ventes",
  name: "Nouvelle vente",
  icon: DollarSignIcon,
  component: AjoutV,
  children: null
};
const ModifierVentes = {
  path: "/ventes/modifier-ventes",
  name: "Modifier vente",
  icon: DollarSignIcon,
  component: ModifV,
  children: null
...
const Depenses = {
  ...
  component: RowSelectionTablesD,
  children: null
};

const AjoutDepenses ={
  path: "/depenses/ajout-depenses",
...
const Fournisseurs = {
  ...
  name: "Fournisseurs",
  icon: UsersIcon,
  component: RowSelectionTablesF,
  children: null
};

const AjoutFrs = {
  path: "/fournisseurs/ajout-fournisseurs",
